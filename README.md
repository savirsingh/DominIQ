...
(AR)** for a passthrough terrain map with live asset pointers. It resets the
local simulator before starting and again when you press Ctrl+C. The first confirmed boat detection
